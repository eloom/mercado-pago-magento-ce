...
class Eloom_MercadoPago_Helper_Math extends Mage_Core_Helper_Abstract {

	/**
	 * Calcula os Juros.
	 *
	 */
	public static function calculateInterest($total, $interestRate) {
		$payment = 0;
		if ($interestRate != 0) {
			$payment = ($interestRate * $total) / 100;
		} else {
