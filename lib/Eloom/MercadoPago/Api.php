...
class Eloom_MercadoPago_Api {
  ...
  public function get_access_token() {
    ...
    $access_data = Eloom_MercadoPago_RestClient::post(array(
                "uri" => "/oauth/token",
  ...
  public function get_payment($id) {
    ...
    $payment_info = Eloom_MercadoPago_RestClient::get($request);
    return $payment_info;
  }
  ...
  public function get_authorized_payment($id) {
    ...
    $authorized_payment_info = Eloom_MercadoPago_RestClient::get($request);
  ...
  public function refund_payment($id) {
    ...
    $response = Eloom_MercadoPago_RestClient::put($request);
    return $response;
  }
  ...
  public function search_payment($filters, $offset = 0, $limit = 0) {
    ...
    $collection_result = Eloom_MercadoPago_RestClient::get($request);
  ...
  public function create_preference($preference) {
    ...
    $preference_result = Eloom_MercadoPago_RestClient::post($request);
  ...
  public function update_preference($id, $preference) {
    ...
    $preference_result = Eloom_MercadoPago_RestClient::put($request);
    return $preference_result;
  }
  ...
  public function get_preference($id) {
    ...
    $preference_result = Eloom_MercadoPago_RestClient::get($request);
    return $preference_result;
  }
  ...
  public function create_preapproval_payment($preapproval_payment) {
    ...
    $preapproval_payment_result = Eloom_MercadoPago_RestClient::post($request);
  ...
  public function get_preapproval_payment($id) {
    ...
    $preapproval_payment_result = Eloom_MercadoPago_RestClient::get($request);
    return $preapproval_payment_result;
  }
  ...
  public function update_preapproval_payment($id, $preapproval_payment) {
    ...
    $preapproval_payment_result = Eloom_MercadoPago_RestClient::put($request);
    return $preapproval_payment_result;
  }
  ...
  public function get($request, $params = null, $authenticate = true) {
    ...
    $result = Eloom_MercadoPago_RestClient::get($request);
    return $result;
  }
  ...
  public function post($request, $data = null, $params = null) {
    ...
    $result = Eloom_MercadoPago_RestClient::post($request);
    return $result;
  }
  ...
  public function put($request, $data = null, $params = null) {
    ...
    $result = Eloom_MercadoPago_RestClient::put($request);
    return $result;
  }
  ...
  public function delete($request, $params = null) {
    ...
    $result = Eloom_MercadoPago_RestClient::delete($request);
    return $result;
  }
}